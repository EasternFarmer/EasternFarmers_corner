									...
									nodes = {
										{
											n = G.UIT.T,
											config = {
												text = "Also available during the run",
												scale = 0.6,
									...
									nodes = {
										{
											...
											config = {
												...
												colour = G.C.BLUE,
												r = 0.1,
												id = "EF_minesweeper_mainmenu",
												button = "EF_minigames_mainmenu",
												hover = true,
												shadow = true,
											},
											nodes = {
