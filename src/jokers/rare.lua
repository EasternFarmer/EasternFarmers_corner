SMODS.Joker({
	...
	calculate = function(self, card, context)
		...
		if
			...
			or context.pseudorandom_result and not context.result and context.identifier == "wheel_of_fortune"
		then
...
SMODS.Joker({
	...
	joker_display_def = function(JokerDisplay)
		return {
			retrigger_function = function(playing_card, scoring_hand, held_in_hand, joker_card)
				...
				return playing_card
						and SMODS.has_enhancement(playing_card, "m_EF_root")
						and joker_card.ability.extra.retrigger * JokerDisplay.calculate_joker_triggers(joker_card)
					or 0
			end,
		}
	end,
	...
	calculate = function(self, card, context)
		if
			...
			and SMODS.has_enhancement(context.other_card, "m_EF_root")
		then
			return {
