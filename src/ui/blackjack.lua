...
function EF.FUNCS.blackjack.init_card_areas()
  ...
  EF.CARDAREAS.blackjack_player = CardArea(
    0, 0,
    G.CARD_W * 4, G.CARD_H,
    {
        card_limit = 4,
              ...
              nodes={
                {
                  n = G.UIT.C,
                  config = {
                      minw = 2, minh = 1, align = "cm", r = 0.1,
                      money = 10, button = "EF_blackjack_money_select", hover = true,
                      shadow = true, func = "EF_blackjack_money_can_select"
                  },
                  nodes = {
                      {n = G.UIT.T, config = { text="$10", scale = 0.75, colour = G.C.MONEY}, nodes = {}}
                  }
                },
                {
                  n = G.UIT.C,
                  config = {
                      minw = 2, minh = 1, align = "cm", r = 0.1,
                      money = 20, button = "EF_blackjack_money_select", hover = true,
                      shadow = true, func = "EF_blackjack_money_can_select"
                  },
                  nodes = {
                      {n = G.UIT.T, config = { text="$20", scale = 0.75, colour = G.C.MONEY}, nodes = {}}
                  }
                },
                {
                  n = G.UIT.C,
                  config = {
                      minw = 2, minh = 1, align = "cm", r = 0.1,
                      money = 30, button = "EF_blackjack_money_select", hover = true,
                      shadow = true, func = "EF_blackjack_money_can_select"
                  },
                  nodes = {
                      {n = G.UIT.T, config = { text="$30", scale = 0.75, colour = G.C.MONEY}, nodes = {}}
                  }
                },
              }
            }
        ...
        nodes={
          {
            n = G.UIT.C,
            config = {
                minw = 2, minh = 1, align = "cm", r = 0.1, colour = G.C.BLUE,
                button = "EF_blackjack_hit", hover = true, shadow = true,
            },
            nodes = {
          ...
          },
          {
            ...
            config = {
                minw = 2, minh = 1, align = "cm", r = 0.1, colour = G.C.BLUE,
                button = "EF_blackjack_stand", hover = true, shadow = true,
            },
            nodes = {
...
function G.FUNCS.EF_blackjack_money_can_select(e)
  if EF.vars.minigames.main_menu then render_blackjack(0) end
